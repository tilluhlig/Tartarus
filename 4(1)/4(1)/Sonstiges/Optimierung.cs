...
namespace _4_1_
{
    ...
    public static class Optimierung
    {
        ...
        public static int Optimiere_Bäume(bool Richtung)
        {
            ...
            String[] BaumBilder =
            {
                "Baum", "Baum2", "Baum3", "Baum4", "Baum5", "Baum6", "Baum7", "Baum8", "Baum9",
                "a_tree04", "a_tree05", "a_tree06", "a_tree08", "a_tree12", "a_tree13", "a_tree22", "Palm_01", "Palm_02",
                "Palm_03", "Palm_04", "Palm_05", "Palm_06", "Palm_07", "Palm_08", "Palm_p01", "Palm_p02", "Palm_p03",
                "Palm_p04"
            };
        ...
        public static int Optimiere_Fahrzeuge(bool Richtung)
        {
            ...
            String[] Bilder2 =
            {
                "ArtillerieRuine", "PanzerRuine", "BaufahrzeugRuine", "ScoutRuine", "Geschuetz",
                "Geschuetz2"
            };
            ...
            String[] Bilder4 =
            {
                "Artillerie2Rohr", "Panzer2Rohr", "nichts", "Scout2Rohr", "GeschuetzRohr",
                "Geschuetz2Rohr"
            };
        ...
        public static int Optimiere_Waffen(bool Richtung)
        {
            String[] WaffenBilder =
            {
                "missle", "bigmissle", "cryomissle", "poisonrocket1", "nuke", "missle", "geschoss"
                ...
                if (File.Exists(Path2 + "4(1)Content\\Backup\\Textures\\" + Datei + Extension))
                {
                    if (!Directory.Exists(Path.GetDirectoryName(Path2 + "4(1)Content\\Textures\\" + Datei + Extension)))
                        Directory.CreateDirectory(
                            Path.GetDirectoryName(Path2 + "4(1)Content\\Textures\\" + Datei + Extension));

                    File.Copy(Path2 + "4(1)Content\\Backup\\Textures\\" + Datei + Extension,
                        Path2 + "4(1)Content\\Textures\\" + Datei + Extension, true);
                }
            }
            else if (Richtung)
            {
