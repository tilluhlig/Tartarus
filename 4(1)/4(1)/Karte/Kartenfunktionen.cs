...
namespace _4_1_
{
    ...
    public static class Kartenfunktionen
    {
        ...
        public static void Bauen_Links(int Typ, Vector2 Position)
        {
            ...
            {
                Kartenformat.SetMaterialFromTo((int)(Position.X + i), (int)Position.Y, (int)(Position.Y + 10), Karte.BACKSTEIN1);
        ...
        public static void Bauen_Hoch(int Typ, Vector2 Position)
        {
            int width = Fahrzeugdaten.FAHRM.Wert[Typ];
            List<Vector3> list = new List<Vector3>();
            for (int i = (int)(-width * 0.75f); i < width * 0.75f; i++)
            {
                Kartenformat.SetMaterialFromTo((int)(Position.X + i), (int)Position.Y - 5, (int)(Position.Y + 5), Karte.BACKSTEIN1);
        ...
        public static void Bauen_Links_Hoch(int Typ, Vector2 Position)
        {
            ...
            {
                if (b < 0) b = 0;
                Kartenformat.SetMaterialFromTo((int)(Position.X + i), (int)(Position.Y - b / diff), (int)(Position.Y + 12 - b / diff), Karte.BACKSTEIN1);
                list.Add(new Vector3((int)(i + Position.X), (int)(Position.Y - b / diff), (int)(Position.Y + 12 - b / diff)));
            }
            Vordergrund.AktualisiereVordergrund(list);
        }
        ...
        public static void Graben_Runter(int Typ, Vector2 Position)
        {
            ...
            {
                Kartenformat.DeleteFromTo((int)(i + Position.X - width), (int)(Position.Y - Texturen.panzerindex[Typ].Height * Fahrzeugdaten.SCALEP.Wert[Typ]), (int)(Position.Y + 10));
                list.Add(new Vector3((int)(i + Position.X - width), (int)(Position.Y - Texturen.panzerindex[Typ].Height * Fahrzeugdaten.SCALEP.Wert[Typ]), (int)(Position.Y + 10)));
            }
            Vordergrund.AktualisiereVordergrund(list);
        }
        ...
        public static void Graben_Links(int Typ, Vector2 Position)
        {
            ...
            {
                Kartenformat.DeleteFromTo((int)(Position.X + width - i), (int)(Position.Y - Texturen.panzerindex[Typ].Height * Fahrzeugdaten.SCALEP.Wert[Typ]), (int)(Position.Y));
                list.Add(new Vector3((int)(Position.X + width - i), (int)(Position.Y - Texturen.panzerindex[Typ].Height * Fahrzeugdaten.SCALEP.Wert[Typ]), (int)(Position.Y)));
            }
            Vordergrund.AktualisiereVordergrund(list);
        }
