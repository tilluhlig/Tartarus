...
namespace _4_1_
{
    ...
    public static class Tastatur
    {
        ...
        public static void SpeichereTastaturbelegung(String Datei)
        {
            ...
            datei.WriteLine(BEWEGUNG_LINKS.Name + "=" + BEWEGUNG_LINKS.Wert);
            datei.WriteLine(BEWEGUNG_RECHTS.Name + "=" + BEWEGUNG_RECHTS.Wert);
            datei.WriteLine(BEWEGUNG_HOCH.Name + "=" + BEWEGUNG_HOCH.Wert);
            datei.WriteLine(BEWEGUNG_RUNTER.Name + "=" + BEWEGUNG_RUNTER.Wert);
            datei.WriteLine(FAHRZEUGWAHL_LINKS + "=" + FAHRZEUGWAHL_LINKS.Wert);
            datei.WriteLine(FAHRZEUGWAHL_RECHTS + "=" + FAHRZEUGWAHL_RECHTS.Wert);
            datei.WriteLine(WAFFENWAHL_LINKS + "=" + WAFFENWAHL_LINKS.Wert);
            datei.WriteLine(WAFFENWAHL_RECHTS + "=" + WAFFENWAHL_RECHTS.Wert);
            datei.WriteLine(REPLAY + "=" + REPLAY.Wert);
            datei.WriteLine(MINIMAP + "=" + MINIMAP.Wert);
            datei.WriteLine(FREIEBEWGUNG + "=" + FREIEBEWGUNG.Wert);
            datei.WriteLine(SPEICHERN + "=" + SPEICHERN.Wert);
            datei.WriteLine(ZUG_BEENDEN + "=" + ZUG_BEENDEN.Wert);
            datei.WriteLine(LINKS + "=" + LINKS.Wert);
            datei.WriteLine(RECHTS + "=" + RECHTS.Wert);
            datei.WriteLine(HOCH + "=" + HOCH.Wert);
            datei.WriteLine(RUNTER + "=" + RUNTER.Wert);
            datei.WriteLine(SCHUSS + "=" + SCHUSS.Wert);
            datei.Close();
        }
