    ...
    public static class Replay
    {
        ...
        public static void DrawReplay(SpriteBatch spriteBatch, Spiel Spiel2)
        {
...

            {
                ...
                {
                    if (playerA[i].isthere[b] &&
                        (playerA[i].pos[b].X != playerB[i].pos[b].X || playerA[i].pos[b].Y != playerB[i].pos[b].Y))
                    {
                        var q = new Vector2(playerA[i].pos[b].X - Spiel2.Fenster.X,
                            playerA[i].pos[b].Y - Spiel2.Fenster.Y);
                        var q2 = new Vector2(playerB[i].pos[b].X - Spiel2.Fenster.X,
                            playerB[i].pos[b].Y - Spiel2.Fenster.Y);
                        ...
                        {
                            spriteBatch.Draw(Texturen.panzerrohrumriss2[playerA[i].KindofTank[b]],
                                new Vector2(xPos - xPos2 + Texturen.RohrPos[playerA[i].KindofTank[b]].X,
                                    yPos - Texturen.RohrPos[playerA[i].KindofTank[b]].Y),
                                null, Color.White, playerA[i].Angle[b] - auxfliphelper + playerA[i].vehikleAngle[b],
                                Texturen.CannonOrigin[playerA[i].KindofTank[b]][1], playerA[i].SizeOfCannon[b],
                        ...
                        else
                        {
                            spriteBatch.Draw(Texturen.panzerrohrumriss2[playerA[i].KindofTank[b]],
                                new Vector2(xPos - xPos2 - Texturen.RohrPos[playerA[i].KindofTank[b]].X,
                                    yPos - Texturen.RohrPos[playerA[i].KindofTank[b]].Y),
                                null, Color.White, playerA[i].Angle[b] + playerA[i].vehikleAngle[b],
                                Texturen.CannonOrigin[playerA[i].KindofTank[b]][0], playerA[i].SizeOfCannon[b],
            ...
            // Begin
            {
                ...
                for (int i = 0; i < anz; i++)
                {
                    ...
                    for (int b = 0; b < anz2; b++, a += 7)
                    {
                        ...
                        playerA[i].Size[b] = Fahrzeugdaten.SCALEP.Wert[playerA[i].KindofTank[b]];
        ...
        {
            var datei = new StreamWriter(Datei);
