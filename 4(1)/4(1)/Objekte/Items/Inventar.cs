...
namespace _4_1_
{
    ...
    public class Inventar
    {
        ...
        /// <summary>
        ///     Gibt Vector (i, anzahl) des Inhalts zurück, dabei werden nicht belegte fächer übersprungen (ohne Klasse 0, nur
        ///     verschiessbare).
        /// </summary>
        ...
        /// <summary>
        ///     Gibt Vector (i, anzahl) des Inhalts zurück, dabei werden nicht belegte fächer übersprungen (auch nicht
        ///     verschiessbare)
        /// </summary>
        /// <param name="id">id einer vorhandenen Munition</param>
        /// <returns>vector2 (Position in List-int- Munition, anzahl), (-1,0) wenn nicht vorhanden</returns>
        ...
        public int GibMunitionsarten()
        {
            ...
            int anz = 0;
            for (int i = 0; i < Munition.Count(); i++)
                if (Munition[i] > 0 && Waffendaten.Verschiessbar[i] != 0 && Waffendaten.Verschiessbar[i] != 5) anz++;
            return anz;
        }
        ...
        public List<String> Speichern()
        {
            ...
            data.Add("MaxFaecher=" + MaxFaecher);
            data.Add("Fachgroeße=" + Fachgroesse);
