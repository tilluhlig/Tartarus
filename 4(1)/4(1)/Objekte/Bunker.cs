...
namespace _4_1_
{
    ...
    public class Bunker
    {
        ...
        /// </summary>
        private static Var<bool> MOD_BUNKER_LEBENSLINIE = new Var<bool>("BUNKER_LEBENSLINIE", false, ref BUNKER_LEBENSLINIE);

        /// <summary>
        /// MOD-Variable, Bunker kann zerstört werden
        /// </summary>
        private static Var<bool> MOD_BUNKER_ZERSTOERUNG = new Var<bool>("BUNKER_ZERSTOERUNG", false, ref BUNKER_ZERSTOERUNG);
        ...
        public int PrüfeObZerstörung(int id, Vector2 Explosionspunkt, int Explosionsradius)
        {
            ...
            Color[] temp = new Color[Texturen.bunker[0].Width * Texturen.bunker[0].Height];
            Texturen.bunker[0].GetData(temp);
            Texture2D tmp = new Texture2D(Texturen.bunker[0].GraphicsDevice, Texturen.bunker[0].Width, Texturen.bunker[0].Height);
            tmp.SetData(temp);
        ...
        {
            Kollision[id] = new KollisionsObjekt(Texturen.bunker[0], Texturen.bunker[0].Width, Texturen.bunker[0].Height, Optimierung.Skalierung(0.25f), false, false, false, new Vector2(0, 0)); // Baumdata.scale[BunkerTyp[i]]
        }
        ...
        {
            Zerstörung[id] = new ZerstörungsObjekt(Texturen.bunker[0].Width, Texturen.bunker[0].Height, Optimierung.Skalierung(0.25f), false, false, false);
        }
