...
namespace HTTP
{
    ...
    public static class HTTP
    {
        ...
        /// <param name="next">The next.</param>
        /// <returns>List{String}.</returns>
        public static List<String> upload(String name, String passwd, String gameid, String map, String data, String next)
        {
        ...
        /// <param name="Funktion">The funktion.</param>
        /// <returns>List{String}.</returns>
        private static List<String> Send5(String name, String passwd, String gameid, String map, String data, String next, String Funktion)
        {
        ...
        /// <param name="next">The next.</param>
        /// <returns>List{String}.</returns>
        private static List<String> Send(String name, String passwd, String newpasswd, String gameid, String map, String data, String Funktion, String email, String version, String next)
        {
