...
namespace Hauptfenster
{
    ...
    public partial class Form1 : Form
    {
        ...
        public static class Colors
        {
            ...
            public static String ToName(System.Drawing.Color Name)
            {
                return System.Drawing.ColorTranslator.ToHtml(Name).ToString();
            }
        }
        ...
        public Form1()
        {
            ...
            Size = new System.Drawing.Size(909, 611);
            ...
            Hauptfenster.Tausch.Mod = "B.conf";
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            if (!checkBox3.Checked) FormBorderStyle = System.Windows.Forms.FormBorderStyle.Sizable;

            //  Tausch.screenwidth = 1024;
            //  Tausch.screenheight = 768;
            Size = new System.Drawing.Size(Tausch.screenwidth, Tausch.screenheight);
            //Size = new System.Drawing.Size(800, 600);
            Width = Size.Width;
            Height = Size.Height;
        ...
        private void textBox2_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar == '\r')
            {
                ...
                Insert(richTextBox1, q, System.Drawing.Color.Red);
                textBox2.Text = "";
            }
        }
                ...
                for (int i = 0; i < Tausch.Input.Count; i++)
                {
                    if (Tausch.Input[i] == "<SPIELSTART>")
                    {
                        ...
                        else
                        {
                            ...
                            Insert(richTextBox1, q, System.Drawing.Color.Blue);
                        }
                }
                Tausch.Input.Clear();
            }
        ...
        private void button10_Click(object sender, EventArgs e)
        {
            ...
            if (checkBox2.Checked)
            {
                ...
                {
                    StreamReader datei = new StreamReader("Content\\sgames.txt");
            ...
            else
            {
                ...
                StreamWriter datei = new StreamWriter("Content\\sgames.txt");
        ...
        private void button11_Click(object sender, EventArgs e)
        {
            ...
            if (checkBox2.Checked)
            {
                ...
                {
                    StreamReader datei = new StreamReader("Content\\ogames.txt");
            ...
            else
            {
                ...
                StreamWriter datei = new StreamWriter("Content\\ogames.txt");
        ...
        private void button14_Click(object sender, EventArgs e)
        {
            ...
            if (checkBox2.Checked)
            {
                Insert(richTextBox2, "Sie sind Offline!", System.Drawing.Color.Red);
                return;
            }
            ...
            if (!HTTP.HTTP.IsFailure(list))
            {
                ...
                timer2_Tick(null, null);
                Insert(richTextBox2, "Spiel erstellt", System.Drawing.Color.Red);
            }
            else
                Insert(richTextBox2, HTTP.HTTP.Get_Meldung(list), System.Drawing.Color.Red);
        }
        ...
        private void button9_Click(object sender, EventArgs e)
        {
            ...
            String Pfad = "";
            HTTP.HTTP.gameid = HTTP.HTTP.sgames[listBox1.SelectedIndex].ToString().Trim(' ');
            ...
            if (!File.Exists(Pfad + "OldMap.dat") && !File.Exists(Pfad + "Map.dat") && !fail)
            {
                ...
                if (!HTTP.HTTP.IsFailure(list))
                {
                    StreamWriter datei = new StreamWriter(Pfad + "OldMap.dat");
            ...
            if (!File.Exists(Pfad + "OldData.dat") && !File.Exists(Pfad + "Data.dat") && !fail)
            {
                ...
                if (!HTTP.HTTP.IsFailure(list))
                {
                    StreamWriter datei = new StreamWriter(Pfad + "OldData.dat");
                    for (int i = 1; i < list.Count; i++) datei.WriteLine(list[i]);
                    datei.Close();
                }
                else
            ...
            {
                System.IO.File.Delete(Pfad + "GameInfo.dat");
                List<String> list = HTTP.HTTP.get_gameinfo();
                if (!HTTP.HTTP.IsFailure(list))
                {
                    StreamWriter datei = new StreamWriter(Pfad + "GameInfo.dat");
                    for (int i = 1; i < list.Count; i++) datei.WriteLine(list[i]);
                    datei.Close();
                }
                else
            ...
            if (!fail && File.Exists(Pfad + "GameInfo.dat") && (File.Exists(Pfad + "OldData.dat") && File.Exists(Pfad + "OldMap.dat")) || (File.Exists(Pfad + "Data.dat") && File.Exists(Pfad + "Map.dat")))
            {
                // Spiel starten
                StreamReader datei = new StreamReader(Pfad + "GameInfo.dat");
                ...
                if (!HTTP.HTTP.IsFailure(list))
                {
                    ...
                    {
                        Insert(richTextBox2, "Spieler ist nicht am Zug", System.Drawing.Color.Red);
        ...
        private void button17_Click(object sender, EventArgs e)
        {
            ...
            for (int p = 0; p < listBox1.Items.Count; p++)
            {
                ...
                if ((File.Exists(Pfad + "OldData.dat") && File.Exists(Pfad + "OldMap.dat")) || (File.Exists(Pfad + "Data.dat") && File.Exists(Pfad + "Map.dat")))
                {
                    // Spiel starten
                    Insert(richTextBox2, ID + " OK", System.Drawing.Color.Green);
                }
                else
                    Insert(richTextBox2, ID + " FAIL", System.Drawing.Color.Red);
            }
        }
        ...
        private void button12_Click(object sender, EventArgs e)
        {
            ...
            HTTP.HTTP.gameid = HTTP.HTTP.ogames[listBox2.SelectedIndex * 3].ToString().Trim(' ');
            ...
            if (!HTTP.HTTP.IsFailure(list))
            {
                ...
                HTTP.HTTP.gameid = list[1].TrimStart(' ');
                timer2_Tick(null, null);
                Insert(richTextBox2, HTTP.HTTP.Get_Meldung(list), System.Drawing.Color.Green);
            }
            else
                Insert(richTextBox2, HTTP.HTTP.Get_Meldung(list), System.Drawing.Color.Red);
        }
        ...
        {
            Hauptfenster.Form1.ActiveForm.Text = Hauptfenster.Form1.ActiveForm.Width.ToString() + "x" + Hauptfenster.Form1.ActiveForm.Height.ToString();
        }
    ...
    public static class Tausch
    {
        ...
        /// The screenheight
        /// </summary>
        public static int screenheight = (int)(System.Windows.Forms.Screen.PrimaryScreen.Bounds.Height * 1f);
