...
namespace Minesweeper
{
    public static class Minesweeper
    {
        ...
        // speichert.. 0==normal, 1==Feld wurde gedrückt, 2==markierung für vermutete Mine gesetzt
        private static int[] Zahlen;

        private static int Zeit; // wieviel Zeit ist bereits verstrichen
        // wieviele Felder
        // Wieviele Minen hat das Spiel?

        // Die Bilderliste für die Felder (0-8, Minenbilder, Felderbilder)
        // Das Label für die anzeige der noch nicht markierten Minen
        private static Label Zeitanzeige;
        ...
        public static void AddMinenanzeige(int wert)
        {
            ...
            if (Minen > 0)
            {
                Minenanzeige.Text = (Minen).ToString().PadLeft(3, '0');
            }
            else
        ...
        public static void InitSpielfeld(int _Minen, int _Breite, int _Hoehe, Form1 frm, PictureBox Zeichenflaeche,
            ImageList _Pictures, Label _Minenanzeige, Label _Zeitanzeige, CheckBox _Schwer)
        {
            ...
            for (int i = 0; i < Breite*Hoehe; i++)
            {
                if (i/Breite == 0 || i/Breite == Hoehe - 1 || i%Breite == 0 || i%Breite == Breite - 1)
                {
                    ...
                    var temp = new MouseEventArgs(MouseButtons.Left, 1, 0, 0, 0);
        ...
        // speichert die Zahlen ("wieviele Minen im Umkreis")
        ...
        private static Image GetBild(int position, bool click)
        {
            ...
            var fntFont = new Font("Courier New", 10f, FontStyle.Regular, GraphicsUnit.Point, 178, false);
            var temp = new Bitmap(Pictures.Images[2]);
            ...
            if (Zahlen[position] > 0)
            {
                ...
                Color[] Farbe =
                {
                    Color.Black, Color.Blue, Color.Red, Color.Green, Color.Indigo, Color.Orange, Color.Gold,
                    Color.Coral
                };
