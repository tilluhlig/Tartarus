    ...
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else if (Spiel == "FloodIt")
            {
                ...
                label8.Top = 4;
                label8.Text =
                    "Erreichen Sie es mit möglichst wenig Zügen, das alle Felder die selbe Farbe besitzen,\n" +
            ...
            else if (Spiel == "LightsOff")
            {
                LightsOff.InitSpielfeld(5, 5, this, pictureBox1, imageList1, label1);
                label8.Left = button1.Left;
                label8.Top = button1.Top + button1.Height + 15;
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            {
                String Text = "";
                var Datei = new StreamReader(Application.StartupPath + "\\log.txt");
        ...
        private void ShowFloodIt()
        {
            ...
            pictureBox1.Width = Width - pictureBox1.Left - 20;
            pictureBox1.Height = Height - pictureBox1.Top - pictureBox2.Height - 40;
            Width = 491;
            Height = 348;
        ...
        private void ShowLightsOff()
        {
            ...
            pictureBox1.Width = Width - pictureBox1.Left - 20;
            pictureBox1.Height = Height - pictureBox1.Top - 40;
            Width = 491;
            Height = 348;
            Minesweeper.StopSpiel(false);
            Minesweeper.KillSpiel();
